...
print("No space left on device part 1:", sum(s for s in dirs.values() if s <= 100_000))

free = 70_000_000 - dirs["/"]
needed = 30_000_000 - free
print("No space left on device Part 2:", min(v for v in dirs.values() if v > needed))